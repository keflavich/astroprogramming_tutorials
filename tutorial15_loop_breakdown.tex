...
\newcommand{\hmwkTitle}{Tutorial: TITLE}
...
\section{Tutorial: Loops }

Tutorial 14 contained some rather complicated use of loops.
This one will break that down a little.

Make a \verb|list| of ingredients.  Include tomatoes, zucchini, mozzarella,
and at least three others.  These should be strings.
